    ...
    <div class="sm:p-2 mx-auto">
        <div class="sm:grid lg:grid-cols-2 xl:grid-cols-3 sm:gap-4">
            @foreach ($galleries as $gallery)
                <div class="h-72 sm:rounded bg-cover bg-center" style="background-image: url('/{{ $gallery->getImages()->first()->getPathWithSlug(\App\Console\Commands\BuildGalleries::THUMBNAIL_SUFFIX) }}');">
